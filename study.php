...
?>
 ...
 // var now=now_num.toString();
  ...
  var n="study.php?UID="+UID+"&&Number="+number+"&&Date="+date+"&&Description=";
...
var str1 ="study.php?UID="+"<?php echo $_GET["UID"];?>"+"&Number="+"<?php echo $_GET["Number"];?>"+"&Description="+testform.Description.value+"&Date=";
...
{
var str1 ="study.php?UID="+UID+"&&Description="+testform.Description.value+"&&Number=";
