...
FROM studies,series,patients
WHERE  studies.id=series.study_id AND patients.id = studies.patientID_id AND series.status='active' AND series.dcm_Modality='MR'
ORDER BY diff ASC;";}
...
var str1 ="MR_tab.php?PID="+"<?php echo $_GET["PID"];?>"+"&Number="+"<?php echo $_GET["Number"];?>"+"&Description="+"<?php echo $_GET["Description"];?>"+"&ID=";
...
var str1 ="MR_tab.php?PID="+"<?php echo $_GET["PID"];?>"+"&Number="+"<?php echo $_GET["Number"];?>"+"&Description="+"<?php echo $_GET["Description"];?>"+"&Date=";
...
var str1 ="MR_tab.php?PID="+"<?php echo $_GET["PID"];?>"+"&Number="+"<?php echo $_GET["Number"];?>"+"&Description="+"<?php echo $_GET["Description"];?>"+"&Diff=";
...
<div class="navbar"> 
 ...
 <form id="form1"  formaction="MR_tab.php" method="get">
