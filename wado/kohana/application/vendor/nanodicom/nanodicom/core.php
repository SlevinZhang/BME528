...
abstract class Nanodicom_Core {
	...
	*/
	...
	public function is_dicom($allow_partial = FALSE)
	{
		...
		// Otherwise, check only for success and not empty datasets 
		return (self::SUCCESS == $this->status AND count($this->_dataset) AND isset($this->_dataset[0x0002]));
	}
	 ...
	 *                   load dictionaries when parsing
