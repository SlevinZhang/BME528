...
(function (global) {
  ...
  extend(fabric.Canvas.prototype, /** @scope fabric.Canvas.prototype */ {
    ...
    _initWrapperElement: function () {
	  ...
	  var style = {};
      for (var prop in this.upperCanvasEl.style) {
		style[prop] = this.upperCanvasEl.style[prop];
      }
      fabric.util.setStyle(this.wrapperEl, style);
    ...
    _applyCanvasStyle: function (element) {
      var width = this.getWidth() || element.getAttribute('width') || parseInt(element.style.width, 10) || element.width,
          height = this.getHeight() || element.getAttribute('height') || parseInt(element.style.height, 10) || element.height;
