...
<!-- Put the Form html data here. The name of each input should match the database. -->
	...
	<div class="inner">	
		<table class="center">
			...
			<tr>
				<th style="text-align:center" colspan="2">Timing of Scan:</th>
			</tr>
			<tr>
	...
	<div class="inner">
		<table class="center">
			...
			<tr>
				<td class="left">Dimensions: X(cm):</td>
	...
	<div class="inner">
		...
		<table id="templateAreas" class="center striped" width="90%">
			...
			<tr>
				<th >Deep Hemispheric Structures</th>
			</tr>
			<tr>
			...
			<tr>
				<th >Brainstem / Cerebellar Involvement</th>
			</tr>
			<tr>
	...
	<div class="inner">
		<table class="center">
			<tr>
				<th style="text-align:center">New Non-Index Lesion or Lesions (ischemic or hemorrhagic stroke):</th>
			</tr>	
			<tr>
					...
					<div>
						...
						<div>
							<table class="center" width="100%">
								...
								<tr>
									<td class="left">Dimensions: X(cm):</td>
									<td><input type="text" name="lesion1x" class="l1"></td>
								</tr> 
								<tr>
									<td class="left">Y(cm):</td>
									<td><input type="text" name="lesion1y" class="l1"></td>
								</tr>
								<tr>
									<td class="left">Z(cm):</td>
									<td><input type="text" name="lesion1z" class="l1"></td>
								</tr>
								<tr>
									<td class="left">Estimated Volume ((X*Y*Z)/2) (cm<sup>3</sup>)</td>
								...
								<tr>
									<td class="left">Dimensions: X(cm):</td>
									<td><input type="text" name="lesion2x" class="l2"></td>
								</tr> 
								<tr>
									<td class="left">Y(cm):</td>
									<td><input type="text" name="lesion2y" class="l2"></td>
								</tr>
								<tr>
									<td class="left">Z(cm):</td>
									<td><input type="text" name="lesion2z" class="l2"></td>
								</tr>
								<tr>
									<td class="left">Estimated Volume ((X*Y*Z)/2) (cm<sup>3</sup>)</td>
								...
								<tr>
									<td class="left">Dimensions: X(cm):</td>
									<td><input type="text" name="lesion3x" class="l3"></td>
								</tr> 
								<tr>
									<td class="left">Y(cm):</td>
									<td><input type="text" name="lesion3y" class="l3"></td>
								</tr>
								<tr>
									<td class="left">Z(cm):</td>
									<td><input type="text" name="lesion3z" class="l3"></td>
								</tr>
								<tr>
									<td class="left">Estimated Volume ((X*Y*Z)/2) (cm<sup>3</sup>)</td>
					...
					<div>
						...
						<div>
							<table class="center" width="100%">
								...
								<tr>
									<td class="left">Dimensions: X(cm):</td>
									<td><input type="text" name="oldstroke1x" class="ol1"></td>
								</tr> 
								<tr>
									<td class="left">Y(cm):</td>
									<td><input type="text" name="oldstroke1y" class="ol1"></td>
								</tr>
								<tr>
									<td class="left">Z(cm):</td>
									<td><input type="text" name="oldstroke1z" class="ol1"></td>
								</tr>
								<tr>
									<td class="left">Estimated Volume ((X*Y*Z)/2) (cm<sup>3</sup>)</td>
								...
								<tr>
									<td class="left">Dimensions: X(cm):</td>
									<td><input type="text" name="oldstroke2x" class="ol2"></td>
								</tr> 
								<tr>
									<td class="left">Y(cm):</td>
									<td><input type="text" name="oldstroke2y" class="ol2"></td>
								</tr>
								<tr>
									<td class="left">Z(cm):</td>
									<td><input type="text" name="oldstroke2z" class="ol2"></td>
								</tr>
								<tr>
									<td class="left">Estimated Volume ((X*Y*Z)/2) (cm<sup>3</sup>)</td>
								...
								<tr>
									<td class="left">Dimensions: X(cm):</td>
									<td><input type="text" name="oldstroke3x" class="ol3"></td>
								</tr> 
								<tr>
									<td class="left">Y(cm):</td>
									<td><input type="text" name="oldstroke3y" class="ol3"></td>
								</tr>
								<tr>
									<td class="left">Z(cm):</td>
									<td><input type="text" name="oldstroke3z" class="ol3"></td>
								</tr>
								<tr>
									<td class="left">Estimated Volume ((X*Y*Z)/2) (cm<sup>3</sup>)</td>
...
/*	$('[name="predominant"]').change(function(){
	...
	/*
	function setMaxDiameter(x, y, diameter) {
		var X = $(x).val();
		var Y = $(y).val();
