...
<?php
if($_POST['actype']=='insert')
{
$Restrict="INSERT INTO case_report (Study_uid,Study_id,Reviewer,data) VALUES('".$_POST['Study_uid']."','".$_POST['Study_id']."','".$_SESSION['MM_Username']."','".date("Y-m-d H:i:s")."')";
mysql_query($Restrict,$dose) or die(mysql_error());
...
$sql1="select * from case_report where Study_id='".$_POST['Study_id']."' AND Study_uid='".$_POST['Study_uid']."' AND Reviewer='".$_SESSION['MM_Username']."'" ;
$result=mysql_query($sql1,$dose) or die(mysql_error());
...
<h1>Case Report</h1>
<div id="insert">
<form action="case_report.php" method="post">
<table class="table table-bordered" style="solid:black;width:600px" >
<input type="hidden"  name="actype" value="insert"/>
...
<tr><td>Date of fundus images used for analysis</td><td>Date of symptom onset</td></tr>
...
<input type="submit" class="btn btn-primary" value="Insert a new record"/>
</form>

</div>
<div id="confirm" style="display:none";>
<form action="case_report.php" method="post"><table class="table table-bordered" style="solid:black" >
<input type="hidden"  name="actype" value="confirm">
<input type="hidden"  name="Study_uid" value="<?php echo $_POST['Study_uid'];?>">

<div class="form-group" >
    <label for="Study_id">Subject_id</label>
    <input type="text" class="form-control" name="Study_id" placeholder=" Enter StudyID">
  </div>
  <div class="form-group" >
    <label for="Reviewer">Reviewer Initial</label>
    <input type="text" class="form-control" name="Reviewer" placeholder="Enter Initial">
  </div>
<tr><td rowspan="2">Imaging Modality</td><td colspan="2" class="mul">Timing of Scan</td><td rowspan="2">Stroke Type</td></tr>
...
<button class="btn btn-primary" id="bt1"><a href="list_subject.php?study_uid=<?php echo $_POST['Study_uid'];?>&patientID=<?php echo $_POST['Study_id'];?>">Back to List</a></button>
</div>
...
if($_POST['actype']=='insert')
{
//echo "alert('You have insert this report into database, You could update it once');";
echo "<script>$('#insert').hide();$('#confirm').show();</script>";
predisplay($row);
}?>
</html>