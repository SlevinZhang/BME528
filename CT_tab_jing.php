...
FROM studies,series,patients
WHERE  studies.id=series.study_id AND patients.id = studies.patientID_id AND series.status='active' AND series.dcm_Modality='CT'
ORDER BY diff ASC;";}
...
var str1 ="CT_tab.php?PID="+"<?php echo $_GET["PID"];?>"+"&Number="+"<?php echo $_GET["Number"];?>"+"&Description="+"<?php echo $_GET["Description"];?>"+"&ID=";
...
var str1 ="CT_tab.php?PID="+"<?php echo $_GET["PID"];?>"+"&Number="+"<?php echo $_GET["Number"];?>"+"&Description="+"<?php echo $_GET["Description"];?>"+"&Date=";
...
var str1 ="CT_tab.php?PID="+"<?php echo $_GET["PID"];?>"+"&Number="+"<?php echo $_GET["Number"];?>"+"&Description="+"<?php echo $_GET["Description"];?>"+"&Diff=";
...
{ 
  ...
  var end=10*(num+1);
	var tabstr = "<table class=\"table\" id="+num_id+"><tr><th><a onclick='Order_ID(this)'>PatientID</a></th><th><a onclick='Order_Date(this)'>StudyDate</a></th><th><a href='MR_tab.php?Time=ASC_Time&Number=10'>StudyTime</a></th><th>Stroke Date</th><th>StudyDescription</th><th><a onclick='Order_Diff(this)'>Study Date-Stroke Date</a></th></tr>";
  for(var m=start; m<end&&m<total;m++)
{var study_url="wado/www/admin/study?site=IPILab&study_uid="+a['dcm_StudyInstanceUID'][m];
var newlink_ID="<a onclick='PatientID(this)'>"+a['dcm_PatientID'][m]+"</a>";
...
tabstr = tabstr+"<tr><td>"+newlink_ID+"</td><td>"+newlink_Date+"</td><td>"+newlink_Time+"</td><td>"+newlink_Stroke+"</td><td>"+newlink_Des+"</td><td>"+newlink_diff+"</td></tr>";
  }  
...
<div class="navbar"> 
   <button type="button" id="MR"  class="btn"><a href="ALL_tab.php?Number=10" id="Back_but">HOME</a></button> 
 ...
 <form id="form1"  formaction="CT_tab.php" method="get">
